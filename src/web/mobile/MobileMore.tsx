...
import {ArrowUpCircle, Bookmark, CalendarClock, ChevronRight, Clock, Eye, Files, FolderOpen, LogOut, Mail, Monitor, Moon, PenSquare, Scissors, Search, Send, Settings, ShieldOff, Sun, Tag, Trash2, Users, Bot } from "lucide-react";
...
export default function MobileMore() {
  ...
  return (
    <Screen title="More" largeTitle>
      ...
      <Group>
        <Row to="/assistant" icon={<Bot />} label="Assistant" />
